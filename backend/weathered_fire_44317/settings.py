"""
Django settings for weathered_fire_44317 project.
...
ROOT_URLCONF = 'weathered_fire_44317.urls'
...
WSGI_APPLICATION = 'weathered_fire_44317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_fire_44317 API",
    "DESCRIPTION": "API documentation for weathered_fire_44317 App",
    "VERSION": "v1",
}
